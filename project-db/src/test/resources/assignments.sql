...
insert into assignment(id, member_id, task_id, type, remark) values (1, 3, 1, 'Review', 'Good Job!!');
insert into assignment(id, member_id, task_id, type, remark) values (2, 3, 1, 'Response', 'Start phase 2');
insert into assignment(id, member_id, task_id, type, remark) values (3, 3, 2, 'Review', 'Good Design!!');
insert into assignment(id, member_id, task_id, type, remark) values (4, 3, 2, 'Response', 'Start phase 3');
insert into assignment(id, member_id, task_id, type, remark) values (5, 3, 6, 'Review', 'You do great job for this too, Aung Naing!!');
insert into assignment(id, member_id, task_id, type, remark) values (6, 3, 7, 'Review', 'Keep Going');
